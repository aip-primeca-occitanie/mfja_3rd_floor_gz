...
def main():
    ...
    fig, (ax_z, ax_fz, ax_cmd) = plt.subplots(3, 1, figsize=(10, 8))
    ...
    for ax, ylabel, title in [(ax_z, "z (cm)", "Position z"), (ax_fz, "Fz (N)", "Force Fz"), (ax_cmd, "Δz (cm)", "Commande cartésienne")]:
    ...
    def update(_frame):
        ...
        for line, ax, t, v in [(line_z, ax_z, t_z, z), (line_fz, ax_fz, t_fz, fz), (line_cmd, ax_cmd, t_cmd, cmd)]:
            if len(t) < 2:
                continue
            line.set_data(t, v)
            t_now = t[-1]
        ...
        return line_z, line_fz, line_cmd
