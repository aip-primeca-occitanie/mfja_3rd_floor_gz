...
def generate_launch_description():
    ...
    real_vla_agent = Node(
        ...
        parameters=[{
            ...
            'openai_model': LaunchConfiguration('vla_agent_model'),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='VLA agent provider: mock, openai, or http.',
        ),
        DeclareLaunchArgument(
            'vla_agent_model',
            default_value='',
            description='Optional OpenAI model name. Empty uses OPENAI_MODEL or the agent default.',
        ),
        DeclareLaunchArgument(
