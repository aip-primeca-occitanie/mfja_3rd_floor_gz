...
SCRIPT_PATH = REPO_ROOT / 'mfja_robot_control_config' / 'scripts' / 'room_315_visual_training_event_extractor.py'


def _load_module():
    spec = importlib.util.spec_from_file_location('room_315_visual_training_event_extractor', SCRIPT_PATH)
