...
DEFAULT_INPUT = _env_path('ROOM315_VISUAL_DATASET_ROOT', 'room315_payload_dataset')
DEFAULT_OUTPUT_DIR = _env_path('ROOM315_VISUAL_SPLITS_DIR', 'room315_local_training/splits')
SPLIT_FILENAMES = {
    'train': 'train.jsonl',
    'val': 'val.jsonl',
    'test': 'test.jsonl',
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description='Create deterministic train/val/test splits for Room 315 visual-state event data.'
    )
    parser.add_argument(
        'input',
        nargs='?',
        ...
        help=(
            ...
            'ROOM315_VISUAL_DATASET_ROOT or room315_payload_dataset.'
        ),
    )
    parser.add_argument(
        '--output-dir',
        ...
        help=(
            ...
            'and split_manifest.json. Defaults to ROOM315_VISUAL_SPLITS_DIR or '
