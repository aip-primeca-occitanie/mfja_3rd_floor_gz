...
class Room315PrivilegedShuttleIdentityTracker:
    def __init__(self) -> None:
        ...
        class _Node(Node):
            def __init__(self) -> None:
                super().__init__('room_315_privileged_shuttle_identity_tracker')
                self.declare_parameter('identity_config_path', str(_default_identity_config_path()))
                self.declare_parameter('detections_topic', '/room_315/perception/fiducial_detections')
                self.declare_parameter('tracks_topic', '/room_315/perception/privileged_shuttle_identity_tracks')
                self.declare_parameter('debug_topic', '/room_315/perception/privileged_shuttle_identity_debug')
...
def main() -> int:
    ...
    rclpy.init()
    tracker = Room315PrivilegedShuttleIdentityTracker()
    try:
        tracker.spin()
    finally:
