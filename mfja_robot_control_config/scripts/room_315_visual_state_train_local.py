...
def train_visual_state(args: argparse.Namespace) -> dict[str, Any]:
    ...
    dataset_report = {
        'tool': 'room_315_visual_state_train_local',
        'dataset_mode': DATASET_MODE_VISUAL_STATE,
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help='Split directory. Defaults to ROOM315_VISUAL_SPLITS_DIR or room315_local_training/splits.',
    )
    parser.add_argument(
        '--dataset-root',
        type=Path,
        ...
        help=(
            ...
            'dataset_root, ROOM315_VISUAL_DATASET_ROOT, or room315_payload_dataset.'
        ),
    )
    parser.add_argument(
        '--output-dir',
