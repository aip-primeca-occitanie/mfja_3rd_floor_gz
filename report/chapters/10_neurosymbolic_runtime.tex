...
Symbolic shuttle locations come from the accepted visual observation, not
controller coordinates, which serve only the supervisor's switch-proximity
veto. Only shuttles are removable blockers in this Gazebo-only profile.
