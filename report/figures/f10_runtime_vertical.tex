\begin{tikzpicture}[
  ...
  \node[accepted] (visual) at (42mm,-45mm) {
    \textbf{Calibrate and validate the complete frame}\\[-0.2ex]
    segment and loaded-state gates + freshness/contract checks\\
  ...
  \draw[flow] (visual.south) -- ([xshift=43mm]ground.north);
  ...
  \draw[feedback] (replan.east) -- (80mm,-186mm) |- (visual.east);
