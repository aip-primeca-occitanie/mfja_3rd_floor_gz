...
\label{ch:visual-state-planning}
...
Planning & Fresh PDDL problem $\leftrightarrow$ PlanSys2 plan & Runtime domain plus whole-plan validation & \file{mfja_robot_control_config/config/room_315_planning/pddl/domain_room315_runtime.pddl}; \file{mfja_robot_control_config/scripts/room_315_pddl_plan_translator.py} \\ \rowseparator
Primitive execution & First translated primitive $\leftrightarrow$ supervisor status & Gateway authorization and deterministic supervisor & \file{mfja_robot_control_config/scripts/room_315_task_execution.py}; \file{mfja_robot_control_config/scripts/room_315_rail_safety_supervisor.py} \\ \rowseparator
...
Source files: \file{mfja_robot_control_config/config/room_315_planning/pddl/domain_room315_runtime.pddl},
\file{mfja_robot_control_config/config/room_315_planning/pddl/domain_room315.pddl},
...
Source files: \file{mfja_robot_control_config/scripts/room_315_rail_safety_supervisor.py},
\file{mfja_robot_control_config/launch/room_315_perception_and_safety.launch.py}, and
\file{mfja_robot_control_config/config/room_315_task_execution/rail_safety_supervisor.yaml}.

\file{room_315_rail_safety_supervisor.py} is deterministic. It consumes JSON primitives
on \rosname{/room_315/rail_safety/primitive_command}, reads typed rail/device state and camera
availability, and publishes typed shuttle, switch, and stopper commands. It
reports structured status on \rosname{/room_315/rail_safety/status}.
...
Source files: \file{mfja_robot_control_config/scripts/room_315_visual_state_dataset_recorder.py},
...
\midrule
\endhead
Capture & Scenario manifest $\rightarrow$ guarded episode images/events/data & \file{mfja_robot_control_config/scripts/room_315_visual_state_dataset_recorder.py}; \file{mfja_robot_control_config/scripts/room_315_visual_state_capture.py} \\ \rowseparator
...
\file{mfja_robot_control_config/config/room_315_visual_state/visual_state_training_v4.json},
\file{mfja_robot_control_config/config/room_315_visual_state/visual_state_final_test_v4.json},
and \file{mfja_robot_control_config/config/room_315_visual_state/visual_state_final_test_v4_coverage_extension.json}.
